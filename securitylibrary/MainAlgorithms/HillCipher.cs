...
namespace SecurityLibrary
{
    ...
    public class HillCipher : ICryptographicTechnique<string, string>, ICryptographicTechnique<List<int>, List<int>>
    {
        ...
        {
            List<char> plain = plainText.ToLower().ToList();
            List<int> plainINT = new List<int>();
            List<char> ciph = cipherText.ToLower().ToList();
            List<int> ciphINT = new List<int>();
            char c = 'b';
            for (int i = 0; i < plain.Count; i++)
            {
                //Console.WriteLine(plain[i] - 97);
                plainINT.Add(plain[i] - 97);
            }
            for (int i = 0; i < ciph.Count; i++)
            {
                //Console.WriteLine(keyLIST[i] - 97);
                ciphINT.Add(ciph[i] - 97);
            }
            List<int> key = Analyse(plainINT, ciphINT);
            Console.WriteLine(key.Count);
            List<char> alphabet = "abcdefghijklmnopqrstuvwxyz".ToList();
            List<char> chars = new List<char>();
            for (int i = 0; i < key.Count; i++)
            {
                chars.Add(alphabet[key[i]]);
            }
        ...
        public string Decrypt(string cipherText, string key)
        {
            ...
            {
                //Console.WriteLine(keyLIST[i] - 97);
                keyINT.Add(keyLIST[i] - 97);
            }
            List<int> plain = Decrypt(ciphINT, keyINT);
            Console.WriteLine(plain.Count);
            List<char> alphabet = "abcdefghijklmnopqrstuvwxyz".ToList();
            List<char> chars = new List<char>();
            for (int i = 0; i < plain.Count; i++)
            {
                chars.Add(alphabet[plain[i]]);
            }
            string res = new string(chars.ToArray());
            Console.WriteLine(res);
            return res;
        ...
        {
            List<char> plain = plainText.ToList();
            List<int> plainINT = new List<int>();
            ...
            List<int> ciph = Encrypt(plainINT, keyINT);
            Console.WriteLine(ciph.Count);
            List<char> alphabet = "abcdefghijklmnopqrstuvwxyz".ToList();
            List<char> chars = new List<char>();
            for (int i = 0; i < ciph.Count; i++)
            {
                chars.Add(alphabet[ciph[i]]);
            }
            string res = new string(chars.ToArray());
            Console.WriteLine(res);
            return res;
        ...
        {
            List<char> plain = plain3.ToLower().ToList();
            List<int> plainINT = new List<int>();
            List<char> ciph = cipher3.ToLower().ToList();
            List<int> ciphINT = new List<int>();
            char c = 'b';
            for (int i = 0; i < plain.Count; i++)
            {
            ...
            List<int> key = Analyse3By3Key(plainINT, ciphINT);
            Console.WriteLine(key.Count);
            List<char> alphabet = "abcdefghijklmnopqrstuvwxyz".ToList();
            List<char> chars = new List<char>();
            for (int i = 0; i < key.Count; i++)
